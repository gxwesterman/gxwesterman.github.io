  ...
  return (
    <div>
      <div className="mt-10 text-foreground/80">
        <p>I currently work as a full-stack software developer at <a className="underline text-foreground/90 hover:text-foreground" href="https://www.nagios.com/" target="_blank" rel="noreferrer">Nagios</a>.</p>
        <br/>
